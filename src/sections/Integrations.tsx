                ...
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-lg">
                            We have helped a number of ordinary South Africans
                            achieve their financial freedom and relief from
                            debt. Through our tailored, expert debt solutions,
                            we have allowed individuals and families to have a
                            renewed financial liberation.
                        </p>
                    </div>
